...
@Entity
@Table(name="cost_inboundCheck")
@ApiModel
public class InboundCheck implements Serializable{
	...
	private InboundList inboundList;//所属入库单
	...
	public String toString() {
		return "InboundCheck [id=" + id + ", step=" + step + ", stepPerson=" + stepPerson + ", time=" + time
				+ ", nextStep=" + nextStep + ", nextStepPerson=" + nextStepPerson + ", inboundList=" + inboundList
				+ "]";
	}
