...
public interface ContractPaymentService {
	 ...
	 * @return
	 */
	ResultJson save(ContractPayment contractPayment);
	 ...
	 * @author jiayiwu
	 * @date 2018年4月16日
	 * @param contractPaymentArrary
	 * @return
	 */
	ResultJson importData(JSONArray contractPaymentArrary);
